...
export function TaskItem({
  ...
  return (
    <motion.tr
      ref={setNodeRef}
      style={style}
      className={`task-row ${selected ? "selected" : ""} ${isMultiSelected ? "multi-selected" : ""} ${isCompleting ? "completing" : ""} ${isCompleted ? "completed" : ""} ${isDragging ? "dragging" : ""} ${isShoppingView ? "shopping-view" : ""}`}
